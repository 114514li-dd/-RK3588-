...
class C2fCA(C2f):
    """C2f module with Coordinate Attention for fine-grained texture extraction.

    Applies CA after the C2f bottleneck chain to strengthen position-sensitive features such as
    longitudinal wrinkles, tuberculate protrusions, and oil dots on Bai Zhi (Angelica dahurica).
    """
