...
class CoordinateAttention(nn.Module):
    """Coordinate Attention (CA) module for encoding position-aware channel attention.

    Captures long-range dependencies along horizontal and vertical directions, useful for fine-grained
    textures such as herbal medicine surface patterns and cross-section oil dots.
